...
# Load the data
data = pd.read_excel('https://github.com/praveenbharti1/INX_Employee_Performance/raw/main/data/INX_Future_Inc_Employee_Performance_CDS_Project2_Data_V1.8%20(1).xls')
...
label_encoder = joblib.load(r'../../data/encoder_model.joblib')
...
power_trans = joblib.load(r'../../data/power_transform.joblib')
...
# Save the PCA model
pca = joblib.load(r'../../data/pca_model.joblib')
...
with open('../../data/random_for_class_hyp.pickle', 'rb') as file:
